...
for koff = [0.05,0.5]
    ...
    f2 = figure(2*i+2);
    subplot(221)
    histogram(cluster_bound_tcr,'Normalization','pdf','FaceColor', [0, 0.5, 0.8],'FaceAlpha', 0.5)
    hold on
    title('Bound TCR')

    subplot(222)
    histogram(cluster_bound_np,'Normalization','pdf','FaceColor', [0, 0.5, 0.8],'FaceAlpha', 0.5)
    hold on
    title('Bound NPs')

    subplot(223)
    histogram(cluster_phos_tcr,'Normalization','pdf','FaceColor', [0, 0.5, 0.8], 'FaceAlpha', 0.5, 'DisplayName','Cluster')
    hold on
    title('Phosph. TCRs')
    ...
    figure(f2)
    subplot(221)
    histogram(homo_bound_tcr,'Normalization','pdf','FaceColor', [0.8, 0, 0.5], 'FaceAlpha', 0.5)
    ylabel('pdf')
    title('Bound TCR')

    subplot(222)
    histogram(homo_bound_np,'Normalization','pdf','FaceColor', [0.8, 0, 0.5], 'FaceAlpha', 0.5)
    ylabel('pdf')
    title('Bound NPs')

    subplot(223)
    histogram(homo_phos_tcr,'Normalization','pdf','FaceColor', [0.8, 0, 0.5], 'FaceAlpha', 0.5, 'DisplayName', 'Uniform')
    ylabel('pdf')
    title('Phosph. TCRs')
